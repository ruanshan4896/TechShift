...
function RssAdminPage() {
    ...
    const handleTestProcess = async ()=>{
        ...
        try {
            ...
            if (data_1.success) {
                const successCount = data_1.results?.filter((r)=>r.status === 'success').length || 0;
                const failedCount = data_1.results?.filter((r_0)=>r_0.status === 'failed').length || 0;
...
//# sourceMappingURL=app_admin_rss_page_tsx_2cd54465._.js.map