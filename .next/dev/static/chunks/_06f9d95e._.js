...
function AdminDashboard() {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            const res_0 = await fetch(`/api/articles/${id}`, {
                method: 'DELETE'
            });
            if (res_0.ok) {
                fetchArticles();
            ...
            console.error('Error deleting article:', error_0);
            alert('Có lỗi khi xóa bài viết!');
        }
    };
    if (!isAuthenticated) {
...
_s(AdminDashboard, "Hri36OcjrlXHTNVVlDL7unru0n0=");
_c = AdminDashboard;
var _c;
...
//# sourceMappingURL=_06f9d95e._.js.map